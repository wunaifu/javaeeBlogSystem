...
<html>
  ...
  <h3 align="center">博客登录页面</h3></br></br>
  <div align="center">
    <form action="servlet/LoginServlet" method="post" >
      <input type="text" name="phone" class="input1"></br></br>
      <input type="password" name="password" class="input1"></br></br>
...
<div class="headerBar">
  <div class="logoBar login_logo">
    <div class="comWidth">
      <h3 class="welcome_title" style="margin-left: 110px">欢迎登陆个人博客</h3>
    </div>
  </div>
</div>
  ...
  <div class="loginBox">
    ...
    <div class="login_cont">
      ...
      <div class="login_partners">
        <p class="l_tit">使用合作方账号登陆网站<a href="register.jsp" style="margin-left: 80px;" style="font-size: 23px;">注册</a> </p>
