...
<div id="content">
    ...
    <div class="left" id="c_left">
        <div class="weizi">
            <div class="wz_text">当前位置：<a href="managerpage.jsp">首页><a href="managerusermag.jsp">用户管理</a>><h1>修改用户信息</h1></div>
        </div>
            ...
            <div class="wz" style="min-height: 700px;">
                ...
                <dl>
                    ...
                    <dd style="margin-left: 200px;width: 350px;">
                        <form name id class="Form" action="managerdoupdateuser.jsp" method="post">
