...
<div id="content">
    ...
    <div class="left" id="c_left">
        ...
        <div class="content_text">
                        ...
                        if (userId.equals(re.getString("collectorId"))) {
                            ...
                            while(reE.next()){
                                if (essayid.equals(reE.getString("essayId"))) {
                                    ...
                                    essay.setEssayImage(TimeUtil.dateToString( TimeUtil.stringToDate(re.getString("collectTime"))));
            ...
            <!--wz-->
            <div class="wz">
                <h4>&nbsp;&nbsp;&nbsp;收藏时间：<%=essayList.get(i).getEssayImage()%></h4>
            ...
            %>          </br><h3 align="center">您还没有收藏过文章</h3></br>
            <%
                }
            %>
