...
<div id="content">
    ...
    <div class="left" id="c_left">
        <div class="weizi">
            <div class="wz_text">当前位置：<a href="managerpage.jsp">首页</a>><a href="#">文章</a></a>><h1><%=essay.getEssayTitle()%></h1></div>
        </div>
        <div class="s_tuijian">
            <div class="s_tuijian">
                ...
                <dl>
                    ...
                    <dd>
                        <p class="dd_text_2">
                            ...
                            <span class="left yd" ><a href="collectessay.jsp?essayId=<%=essayId%>&type=1" title="是否收藏该文章" id="collectspan">
                                <%
                                if (collectFlag == true) {
                                %>
                                    已收藏文章
                                ...
                                <%}%>
                                    ...
                                    <span class="left fl"><a href="deletessay.jsp?essayId=<%=essayId%>&type=1"
                                                             onclick='return confirm("确认要删除吗?")'>删除</a></span>
                            ...
                            <div class="wz">
                                <dl>
                                    <dd>
                                        ...
                                        <a href="deletdiscuss.jsp?essayId=<%=essayId%>&discussId=<%=discussList.get(i).getId()%>&type=1"
                                           onclick='return confirm("确认要删除吗?")'>删除</a> <br/>
    ...
    <div class="right" id="c_right">
        ...
        <div class="s_about"style="min-height: 250px;">
            ...
            <form name id class="Form" action="senddiscuss.jsp?type=1" method="post">
