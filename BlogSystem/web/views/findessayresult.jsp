...
<div id="content">
    ...
    <div class="left" id="c_left">
        ...
        <div class="content_text">
            ...
            <!--wz-->
            <div class="wz">
                <form name id class="Form" name="frm" action="findessayresult.jsp" method=post>
            ...
            <!--wz-->
            <div class="wz">
                <h3><a href="essayinfo.jsp?essayId=<%=essayList.get(i).getEssayId()%>" title="文章标题"><%=essayList.get(i).getEssayTitle()%></a></h3>
                <dl>
