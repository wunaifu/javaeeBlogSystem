...
<div id="content">
    ...
    <div class="left" id="c_left">
        <div class="weizi">
            <div class="wz_text">当前位置：<a href="homepage.jsp">首页</a>><a href="myinfo.jsp">个人信息</a>><h1>修改手机号</h1></div>
        </div>
            ...
            <div class="wz" style="min-height: 700px;">
                ...
                <dl>
                    ...
                    <dd style="margin-left: 200px;width: 350px;">
                        <form name id class="Form" action="doupdatephone.jsp" method="post">
                            <input hidden="hidden" name="id" value="<%=userId%>">
                            <span class="wordage">旧手机号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;剩余字数：<span id="sy1" style="color:Red;">11</span></span><br />
                            <input name="pswold" type="number" onkeyup="checkLengthName(this);" style="min-width:280px;min-height: 20px;padding: 5px;"/><br />

                            <span class="wordage">新手机号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;剩余字数：<span id="sy3" style="color:Red;">11</span></span><br />
                            <input name="pswnew" type="number" onkeyup="checkLengthNickname(this);" style="min-width:280px;height: 20px;padding: 5px;"/><br />
